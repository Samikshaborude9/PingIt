...
const howItWorks = [
    {
        ...
        content: "Create an account or log in using your email—no need for a WhatsApp login.",
    },
    {
        step: 2,
        src: "/input.png",
...
export default function Steps() {
    ...
    return(
        <article ref={containerRef} className="relative h-[400vh]">
            <section className= "sticky top-0 overflow-hidden h-screen">
                ...
                >
                   {howItWorks.map((item, index) => (
                            <li
                                key={index}
                                className=" flex flex-col items-start justify-center pb-16 w-[80vw] lg:w-[60vw] xl:w-[50vw] h-screen shrink-0 px-5 md:px-20"
                            >
                                <StepsCards
                                    src={item.src}
            ...
            <motion.div
                ...
                className="fixed left-0 right-0 bottom-4 h-1.5 bg-[#FFFFCC] origin-left"
            />
